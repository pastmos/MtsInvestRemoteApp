...
struct Ru_Mts_Trading_Broker_Commons_PortfolioResponse {
  ...
  var portfolio: Ru_Mts_Trading_Broker_Commons_Portfolio {
    get {return _portfolio ?? Ru_Mts_Trading_Broker_Commons_Portfolio()}
    set {_portfolio = newValue}
  }
  /// Returns true if `portfolio` has been explicitly set.
  var hasPortfolio: Bool {return self._portfolio != nil}
  /// Clears the value of `portfolio`. Subsequent reads from it will return its default value.
  mutating func clearPortfolio() {self._portfolio = nil}

  var positions: [Ru_Mts_Trading_Broker_Commons_Position] = []

  var status: Ru_Mts_Trading_Broker_Commons_PortfolioStatus = .exists

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _portfolio: Ru_Mts_Trading_Broker_Commons_Portfolio? = nil
}
...
struct Ru_Mts_Trading_Broker_Commons_Portfolio {
  ...
  var yieldPerAnnum: GrpcStringDecimal {
    get {return _yieldPerAnnum ?? GrpcStringDecimal()}
    set {_yieldPerAnnum = newValue}
  }
  /// Returns true if `yieldPerAnnum` has been explicitly set.
  var hasYieldPerAnnum: Bool {return self._yieldPerAnnum != nil}
  /// Clears the value of `yieldPerAnnum`. Subsequent reads from it will return its default value.
  mutating func clearYieldPerAnnum() {self._yieldPerAnnum = nil}

  /// номер договора
  var contractID: String = String()

  /// сумма доступная к выводу
  var availableWithdrawAmount: GrpcStringDecimal {
    get {return _availableWithdrawAmount ?? GrpcStringDecimal()}
    set {_availableWithdrawAmount = newValue}
  }
  /// Returns true if `availableWithdrawAmount` has been explicitly set.
  var hasAvailableWithdrawAmount: Bool {return self._availableWithdrawAmount != nil}
  /// Clears the value of `availableWithdrawAmount`. Subsequent reads from it will return its default value.
  mutating func clearAvailableWithdrawAmount() {self._availableWithdrawAmount = nil}
  ...
  var reservedUntil: GrpcOptionalDate {
    get {return _reservedUntil ?? GrpcOptionalDate()}
    set {_reservedUntil = newValue}
  }
  /// Returns true if `reservedUntil` has been explicitly set.
  var hasReservedUntil: Bool {return self._reservedUntil != nil}
  /// Clears the value of `reservedUntil`. Subsequent reads from it will return its default value.
  mutating func clearReservedUntil() {self._reservedUntil = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _liquidationValue: GrpcStringDecimal? = nil
  fileprivate var _assetsValue: GrpcStringDecimal? = nil
  fileprivate var _freeValue: GrpcStringDecimal? = nil
  fileprivate var _reservedValue: GrpcStringDecimal? = nil
  fileprivate var _yield: GrpcStringDecimal? = nil
  fileprivate var _income: GrpcStringDecimal? = nil
  fileprivate var _yieldPerAnnum: GrpcStringDecimal? = nil
  fileprivate var _availableWithdrawAmount: GrpcStringDecimal? = nil
  fileprivate var _reservedUntil: GrpcOptionalDate? = nil
}
...
extension Ru_Mts_Trading_Broker_Commons_PortfolioResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._portfolio) }()
...
extension Ru_Mts_Trading_Broker_Commons_Portfolio: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._liquidationValue) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._assetsValue) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._freeValue) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._reservedValue) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._yield) }()
      case 7: try { try decoder.decodeSingularMessageField(value: &self._income) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._yieldPerAnnum) }()
      case 9: try { try decoder.decodeSingularStringField(value: &self.contractID) }()
      case 10: try { try decoder.decodeSingularMessageField(value: &self._availableWithdrawAmount) }()
      case 11: try { try decoder.decodeSingularMessageField(value: &self._reservedUntil) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._liquidationValue {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    if let v = self._assetsValue {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    if let v = self._freeValue {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }
    if let v = self._reservedValue {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }
    if let v = self._yield {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    }
    if let v = self._income {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
    }
    if let v = self._yieldPerAnnum {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
    }
    if !self.contractID.isEmpty {
      try visitor.visitSingularStringField(value: self.contractID, fieldNumber: 9)
    }
    if let v = self._availableWithdrawAmount {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
    }
    if let v = self._reservedUntil {
  ...
  static func ==(lhs: Ru_Mts_Trading_Broker_Commons_Portfolio, rhs: Ru_Mts_Trading_Broker_Commons_Portfolio) -> Bool {
    ...
    if lhs._liquidationValue != rhs._liquidationValue {return false}
    if lhs._assetsValue != rhs._assetsValue {return false}
    if lhs._freeValue != rhs._freeValue {return false}
    if lhs._reservedValue != rhs._reservedValue {return false}
    if lhs._yield != rhs._yield {return false}
    if lhs._income != rhs._income {return false}
    if lhs._yieldPerAnnum != rhs._yieldPerAnnum {return false}
    if lhs.contractID != rhs.contractID {return false}
    if lhs._availableWithdrawAmount != rhs._availableWithdrawAmount {return false}
    if lhs._reservedUntil != rhs._reservedUntil {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._subTitle) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._amount) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._averagePrice) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._quantityInt) }()
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._yield) }()
        case 8: try { try decoder.decodeSingularMessageField(value: &_storage._income) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._yieldPerAnnum) }()
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._purchaseDate) }()
        case 11: try { try decoder.decodeSingularBoolField(value: &_storage._isFavorite) }()
        case 12: try { try decoder.decodeSingularMessageField(value: &_storage._sort) }()
        case 13: try { try decoder.decodeSingularEnumField(value: &_storage._group) }()
        case 14: try { try decoder.decodeSingularMessageField(value: &_storage._currency) }()
        case 15: try { try decoder.decodeSingularEnumField(value: &_storage._instrumentCommonType) }()
        case 16: try { try decoder.decodeSingularMessageField(value: &_storage._maturityDate) }()
        case 17: try { try decoder.decodeSingularBoolField(value: &_storage._isMaturity) }()
        case 18: try { try decoder.decodeSingularMessageField(value: &_storage._amountRub) }()
        case 19: try { try decoder.decodeSingularMessageField(value: &_storage._yieldRub) }()
        case 20: try { try decoder.decodeSingularMessageField(value: &_storage._incomeRub) }()
        case 21: try { try decoder.decodeSingularMessageField(value: &_storage._yieldPerAnnumRub) }()
        case 22: try { try decoder.decodeSingularMessageField(value: &_storage._quantity) }()
        case 23: try { try decoder.decodeSingularMessageField(value: &_storage._moneyFlowAmount) }()
        case 24: try { try decoder.decodeSingularEnumField(value: &_storage._lifecycleStage) }()
        default: break
        }
      }
    }
